...
Route::delete('inbox', PurgeMessagesController::class)->middleware('can:administer-sink')->name('sink.inbox.purge');
...
Route::delete('inbox/{message}', DestroyMessageController::class)->middleware('can:administer-sink')->name('sink.message.destroy');
